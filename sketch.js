...
function preload(){
  openScreen = loadImage("capa jogo rn.png");
  efcoBrookshireRegular = loadFont("EFCO Brookshire Regular.ttf");
  resumoDoJogo = loadImage("resumo.png");
  imgFase1 = loadImage("tela-fase1.png");
  imgFase2 = loadImage("img-da-fase2.png");
  imgFase3 = loadImage("img-da-fase3.png");
  imgFase4 = loadImage("img-da-fase4.png");
  istrucoespraJogar = loadImage("Intrucoes-jogo.png");
  imgPersonagem = loadImage("indio.png");
  imgPauBrasil = loadImage("pau-brasil.png");
  pauBrasilFalso = loadImage("Arvore-seca.png");
  pauBrasilFalso2 = loadImage("Arvore-seca.png");
  personagem2 = loadImage("portugueses-navio.png");
  marcoDeTouros = loadImage("Marco-de-Touros.png");
  marcoDeTourosFalso = loadImage("pedra.png");
  personagem3 = loadImage("colonizador portugues.png");
  mapaRn = loadImage("mapaRn.png");
  flecha = loadImage("flechaa.png");
  personagem4 = loadImage("portugues construtor.png");
  fortalezaDosReisMagos = loadImage("fortalezaDosReisMagos.png");
  frances = loadImage("frances.png");
  gameOver = loadImage("Game-over.png");
  telaVitoria = loadImage("telaVitoria.png");
  telaVitoriaFase2 = loadImage("telaVitoriaFase2.png");
  telaVitoriaFase3 = loadImage("telaVitoriaFase3.png");
  telaCreditos = loadImage("creditos-1.png");
